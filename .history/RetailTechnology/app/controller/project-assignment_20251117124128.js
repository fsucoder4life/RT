    ...
    return {
        show: function (target, routeCheck, options) {
            ...
            construction.loadData({combinedQuery: query}, function (stores) {
                var katigan = 0, bryant = 0, stephen = 0, russ = 0, palmer = 0, jason = 0, matt = 0, lauren = 0, dylan = 0, unassigned = 0, liz = 0, laurenActive = 0, dylanActive = 0, katiganActive = 0, bryantActive = 0, russActive = 0, stephenActive = 0, baileyActive = 0, jasonActive = 0, lizActive = 0, mattActive = 0, unassignedActive = 0, active = 0;
