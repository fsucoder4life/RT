define([
  'dojo/text!app/view/purchase-order/fabcon-id-tech-purchase-order-editor.html',
  'app/view/report',
        ...
        render: function (options) {
            ...
            me.updatePurchaseOrderItemList = function () {
                reportView.render({
                    ...
                    columns: [
                        { key: 'Vendor', title: 'Vendor', editable: true },
                      {
                          key: 'Description', title: 'Description', editable: true,  transform: function (value, row, data, index) {
