define([
        ...
        'dojo/text!app/view/workflow/pays-order.html',
        ...
        return {
            render: function (options) {
                ...
                me.subject = new TextBox({
                    value: "Store #" + store.StoreNumber + " - " + store.City + " " + store.State + " - POSData, TASQ, Enclosures & ServerEPS",
                    style: "width: 100%"
                }, $(t).find('#subject')[0]);

                //Create the button
                me.submit = new Button({
                    label: "Send PAYS Order"
