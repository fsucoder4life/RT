define([
        ...
        'dojo/text!app/view/tableStoreconfigurationsearch.html',
        'app/widget/dropdown',
    ...
    return {
        render: function (options) {
            ...
            function processData(data) {
                ...
                if (type.length > 0)
                    table.find('#type option[value="' + type + '"]').attr('selected', 'selected');
                if (stallRange.length > 0)
                    table.find('#stallRange option[value="' + stallRange + '"]').attr('selected', 'selected');
                if (driveThru.length > 0)
                    table.find('#driveThru option[value="' + driveThru + '"]').attr('selected', 'selected');
                if (POS.length > 0)
                    table.find('#pos option[value="' + POS + '"]').attr('selected', 'selected');
                if (audio.length > 0)
                    table.find('#audio option[value="' + audio + '"]').attr('selected', 'selected');
                if (dinein.length > 0)
                    table.find('#dineIn option[value="' + dinein + '"]').attr('selected', 'selected');
