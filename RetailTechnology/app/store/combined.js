define(['app/store/issues', 'app/store/notes', 'app/store/sp-utility','app/brands/services/brandServices','app/brands/services/logHelper'], function (issues, notes, utility,brandServices,logHelper) {
    ...
    var combinedMapping = {
        ...
        ows_IT_x0020_Project_x0020_Manager: { mappedName: 'ProjectManager', objectType: 'Text', type: 'select', options: ['Brittany Palmer', 'Josh Rice', 'Kaitlyn Childers', 'Dylan Gehlbach', 'Emily Boatright'] },
        ...
        ows_ISCTotalCost: { mappedName: 'ISCTotalCost', objectType: 'Text' },
