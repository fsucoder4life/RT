define(['app/store/issues', 'app/store/notes', 'app/store/sp-utility'], function (issues, notes, utility) {
    //Setup 
    ...
    var combinedMapping = {
        ...
        ows_IT_x0020_Project_x0020_Manager: { mappedName: 'ProjectManager', objectType: 'Text', type: 'select', options: ['Paige Bailey', 'Josh Rice', 'Kaitlyn Childers', 'Dylan Gehlbach', 'Emily Boatright'] },
