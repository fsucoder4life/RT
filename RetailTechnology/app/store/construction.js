define(['app/store/combined'], function(combined){
    ...
    var constructionMapping = {
        ...
        ows_POPS_x0020_Status: { mappedName: 'PopsStatus', objectType: 'Text', type: 'select', options: ['Not Required', 'Need Requirements', 'Credit Doc to FEE ' + today, 'Credit Doc to FabCon ' + today, 'Estimate to FEE ' + today, 'Need Signature', 'Need Payment', 'PO Requested ' + today, 'PO Issued ' + today, 'Shipped ' + today, 'Delivered'] },
