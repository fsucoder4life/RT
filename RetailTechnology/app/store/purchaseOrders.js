define(['app/utility/sp-utility', 'dojo/number', 'app/brands/services/brandServices', 'app/brands/services/logHelper'], function (utility, dNumber, brandServices, logHelper) {
        //Setup
        ...
        var mapping = {
            ...
            ows_BillingStatus: { mappedName: 'BillingStatus', objectType: 'Text', type: 'select', options: ['Pending ISC Invoices', 'Need to Create ID Tech Invoices', 'ID Tech Invoice Created', 'Invoice Packet to Franchisee ' + today] },
            ...
            ows_ISCTotal: { mappedName: 'ISCTotal', objectType: 'Text', type: 'number', format: function (val) { return val } },
