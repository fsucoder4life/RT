define(['app/store/combined','app/brands/services/brandServices'], async function(combined,brandServices){
    ...
    var combinedconstructionextendMapping = {
        ...
        ows_VP6800_x0020_Installer: { mappedName: 'VP6800Installer', objectType: 'Text' },
        ...
        if (constructionQuery) {
            ...
            $().SPServices({
                ...
                completefunc: function (xData, Status) {
                    ...
                    console.log("completefunc1 in 2");
                    ...
                    console.log("combined.loadData - query 2: " + query);
                    ...
                    var queryComplete = insert(query1, query1loc, '</Values></In><In><FieldRef Name="ID" /><Values>') + query2;

                    combined.loadData({ query: queryComplete }, function (combined) {
