define(['app/brand/services/brandServices'],async function(brandServices){
    ...
    let webUrl = await brandServices.getSharePointUrlByKey("sharePointBaseUrl");
    ...
    var mapping = {
        ows_ID: {mappedName: "ChecklistID", objectType: "Text"},
        ows_Store_x0020_Number: {mappedName: 'StoreNumber', objectType: 'Lookup'},
        ows_Title: {mappedName: 'Title', objectType: 'Text'},
        ows_Status: {mappedName: 'Status', objectType: 'Text'},
        ows_Complete: {mappedName: 'Complete', objectType: 'Boolean'},
        ows_Warn_x0020_Date: {mappedName: 'WarnDate', objectType: 'Text'},
        ows_Due_x0020_Date: {mappedName: 'DueDate', objectType: 'Text'},
    ...
    function create (store, issue, callback) {
        $().SPServices({
            ...
            valuepairs: [
                ...
                ["Status", issue.Status || ''],
                ["Complete", issue.Severity || false],
                ["Warn_x0020_Date", issue.WarnDate || ''],
                ["Due_x0020_Date", issue.DueDate || ''],
    ...
    function logFields () {
        $().SPServices({
            ...
            listName: listName,
            viewName: 'df436e9d-b152-411d-b593-33d99300a2d8',
            completefunc: function(xData, Status) {
