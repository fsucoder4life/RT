define(['app/view/report', 'app/store/combined', 'app/store/construction', 'app/store/combinedconstructionextend', 'app/rules/paymentmod'], function (report, combined, construction, combinedconstructionextend, paymentmodRules) {
    return {
        show: function (target, routeCheck, options) {
                ...
                completefunc: function (xData, Status) {
                    ...
                    $(xData.responseXML).SPFilterNode("z:row").each(function () {
                        ...
                        if (typeof options.franchisee !== 'undefined') {
                            console.log("fran: " + options.franchisee.toUpperCase());
            ...
            var columns = [
                ...
                { key: 'VP6800HughesDoctoHughes', title: 'Hughes Docuemnt sent to Hughes', transform: 'date', editable: true },
