    ...
    return {
        show: function (target, routeCheck, options) {
            ...
            var columns = [
                ...
                {key: 'AudioType', title: 'Audio<br/>Type', editable: true, minWidth: '100px'},
                {key: 'AudioStatus', title: 'Audio<br/>Status', editable: true, minWidth: '175px'},
                {key: 'PosStatus', title: 'POS<br/>Status', editable: true},
                {key: 'AudioDeliveryDate', title: 'Audio<br/>Delivery', transform: 'date', editable: true, minWidth: '100px'},
                {key: 'PosDeliveryDate', title: 'POS<br/>Delivery', transform: 'date', editable: true},
                {key: 'InstallDate', title: 'Install<br/>Date', transform: 'date', editable: true},
                {key: 'PosConfigDate', title: 'POS CAL<br/>Date', transform: 'date', editable: true},
