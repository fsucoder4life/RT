define(['app/view/purchase-order/purchase-order', 'app/store/purchaseOrders', 'app/store/purchaseOrderItems', 'app/store/products', 'dojo/text!resources/style/main.css', 'dojo/text!resources/style/pure-min.css', 'app/store/combined', 'app/store/construction', 'app/utility/sp-utility', 'app/widget/widgetHelper', 'dojo/text!app/view/workflow/fabcon-purchase-order.html'],
  function (summary, purchaseOrderStore, purchaseOrderItemStore, products, mainCss, pureCss, combined, construction, spUtility, widgetHelper, emailTemplate) {
      var self = {
          emailTo: 'kgelfer@fabcon.com; cromero@fabcon.com; Kimberly.Oliver@sonicdrivein.com; BJuarez@fabcon.com; IEscobar@fabcon.com; RAlbrechtsen@fabcon.com; MPerez@fabcon.com; rMagallanes@fabcon.com; ',
      ...
      self.buildPdf = function (view, callback) {
          ...
          req.send("MarginLeft=1&MarginRight=1&MarginTop=1&MarginBottom=1&apikey=1526b4da-614e-4287-8074-dfad0109c538&value=" + encodeURIComponent(html));
      };
