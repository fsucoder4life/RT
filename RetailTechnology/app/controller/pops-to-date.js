    ...
    return {
        show: function (target, routeCheck, options) {
            ...
            var query = new CamlBuilder().Where().All(
                CamlBuilder.Expression().DateField('POPS_x0020_Delivery_x0020_Date').LessThanOrEqualTo(moment('2015-08-31').toISOString()),
                CamlBuilder.Expression().TextField('Project_x0020_Type').NotEqualTo('New')
