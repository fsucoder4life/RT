    ...
    return {
        show: function (target, routeCheck, options) {
            ...
            var columns = [
                ...
                { key: 'Classification', title: 'SII/SRI' },
                { key: 'DMA', title: 'Market' },
                { key: 'FranchiseGroup', title: 'Franchise' },
                { key: 'Address', title: 'Address' },
                { key: 'City', title: 'City' },
                { key: 'State', title: 'State' },
                { key: 'Zip', title: 'Zip' },
                { key: 'StorePhone', title: 'Phone' },
                { key: 'Pos', title: 'Current POS' },
                { key: 'OracleServerUpgradeServerType', title: 'Oracle Server Type' },
                { key: 'OracleServerUpgradeOrdered', title: 'Ordered' },
                { key: 'OracleServerUpgradeDelivery', title: 'Delivery' },
                { key: 'OracleServerUpgradeGoLive', title: 'Go-Live' },
                { key: 'OracleServerUpgradeInstaller', title: 'Installer' },
                { key: 'OracleServerUpgradeSerialNum', title: 'Serial #' },
                { key: 'OracleServerUpgradeWindowsUpgrade', title: 'Windows Upgrade' },
                { key: 'OracleServerUpgradeGoLive2', title: 'Go-Live' },
                { key: 'OracleServerUpgradePM', title: 'Project Manager' },

                
            ];

            //Define report title
            var title = 'Oracle Server Upgrade - Upcoming Projects';
