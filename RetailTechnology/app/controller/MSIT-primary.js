    ...
    return {
        show: function (target, routeCheck, options) {
            ...
            var query = new CamlBuilder().Where().All(
                CamlBuilder.Expression().DateField('GO_x0020_LIVE_x0020_DATE').GreaterThanOrEqualTo('2017-02-01T00:00:00.000Z'),
            ...
            var columns = [
                ...
                {key: 'HughesPrimaryDateType', title: 'Primary<br/>Date Type', editable: true},
            ...
            //Define report title
            var title = 'Hughes - Primary Installs';
