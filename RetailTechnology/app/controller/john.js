    ...
    return {
        show: function (target, routeCheck, options) {
            ...
            var columns = [
                ...
                {key: 'StallCount', title: 'Stalls', transform: 'number'},
                {key: 'PatioCount', title: 'Patio', transform: 'number'},
                {key: 'TotalStalls', title: 'Total', transform: 'number'},
            ...
            var filter = function (arr) {
                ...
                _.forEach(arr, function (store, index) {
                    if (store.DriveThruFormat.toUpperCase() === 'DOUBLE') {
                        keepers.push(store);
                    }
                });
