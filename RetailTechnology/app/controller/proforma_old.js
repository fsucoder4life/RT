...
//        ProjectManagementFee: 1500, - pending update from Christina
        ...
        PosData: {
            ...
            PaysClientAntenna: 13.80,
            PaysServerRadio: 95.00,
            PaysServerAntenna: 13.80,
            PaysServerPowerSupply: 7.30,
            SerialCable: 6.30,
            PaysAntennaCable: 42.50,
            Pays: 385.00
        },
        Hughes: {
            Wireless: 799.00,
...
//                    });
                ...
                if (store.ProjectType === "Relocation" || store.ProjectType === "Remodel" || store.ProjectType === "Rebuild") {
                    var commWorksAmount = 0;
                ...
                if (store.ProjectType === "POS Conversion") {
                    ...
                    items.push({
                        ...
                        Price: constants.Hughes.Wireless + constants.Hughes.Revisit,
                        Quantity: 1,
                        Taxable: false
                    });
                }
