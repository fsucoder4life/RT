    ...
    return {
        show: function (target, routeCheck, options) {
            ...
            $().SPServices({
                ...
                CAMLQuery: "<Query><Where><Geq><FieldRef Name='OracleCEGoLive' /><Value IncludeTimeValue='False' Type='DateTime'><Today /></Value></Geq></Where><OrderBy><FieldRef Name='OracleCEGoLive' /></OrderBy></Query>",
                async: false,
