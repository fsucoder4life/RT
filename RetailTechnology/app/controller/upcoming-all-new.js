define(['app/view/report', 'app/store/combined', 'app/store/construction', 'app/rules/construction', 'app/email'], function (report, combined, construction,constructionRules, email) {
    return {
        show: function (target, routeCheck, options) {
            ...
            $().SPServices({
                ...
                CAMLViewFields: "<ViewFields><FieldRef Name='VP6800_x0020_IT_x0020_PM' /><FieldRef Name='VP6800_x0020_Go_x0020_Live' /><FieldRef Name='Store_x0020_Number' /><FieldRef Name='VP6800_x0020_Installer' /></ViewFields>",
                ...
                completefunc: function (xData, Status) {
                    $(xData.responseXML).SPFilterNode("z:row").each(function () {
                        ...
                        store.SeniorVicePresident = $(this).attr("ows_Senior_x0020_Vice_x0020_Presiden");
                        store.RegionalVicePresident = $(this).attr("ows_Regional_x0020_Vice_x0020_Presid");
                        store.ProjectManager = $(this).attr("ows_VP6800_x0020_IT_x0020_PM");
