define(['app/view/sync/construction-report', 'app/view/report', 'app/store/combined', 'app/store/construction', 'app/store/notes', 'dijit/registry'], function (view, report, combined, construction, noteStore, registry) {
    var compareData = [];
    var mapping = {
        entityName: -1,
        projectStatus: -1,
