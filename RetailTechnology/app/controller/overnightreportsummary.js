    ...
    return {
        show: function (target, routeCheck, options) {
            ...
            $().SPServices({
                ...
                CAMLQuery: CSquery,
                CAMLViewFields: "<ViewFields><FieldRef Name='ID' /><FieldRef Name='POS_x0020_Selection' /><FieldRef Name='Title' /><FieldRef Name='Store_x0020_Phone' /><FieldRef Name='Address_x0020_Full' /><FieldRef Name='Zipcode' /><FieldRef Name='Franchise_x0020_Group' /><FieldRef Name='Market_x0020_DMA_x0020_Name_x002' /><FieldRef Name='City' /><FieldRef Name='State_x0020_' /></ViewFields>",
                async: false,
                completefunc: function (xData, Status) {
                    $(xData.responseXML).SPFilterNode("z:row").each(function () {
            ...
            //Define report title
            var title = 'Overnight Report Summary';
