function ApplyFilters() {
    ...
    window.location.href = "https://www.sonicpartnernet.com/Scoop/Information%20Services/PMT/Roll%20Out/SitePages/RetailTechnology/index.aspx#reports/paymentmodprojectdates4" + itpm + startDate + endDate + sortByGoLiveDate + franchisee + sitesurveycompleted + orderdocsent;
    ...
    return {
        show: function (target, routeCheck, options) {
            ...
            if (startDate.length > 0 && endDate.length > 0)
                CAMLQuery = "<Query><Where><And><Geq><FieldRef Name='VP6800_x0020_Go_x0020_Live' /><Value IncludeTimeValue='False' Type='DateTime'>" + startDate + "</Value></Geq><Leq><FieldRef Name='VP6800_x0020_Go_x0020_Live' /><Value IncludeTimeValue='False' Type='DateTime'>" + endDate + "</Value></Leq></And></Where></Query>";
            else if (startDate.length > 0)
                CAMLQuery = "<Query><Where><Geq><FieldRef Name='VP6800_x0020_Go_x0020_Live' /><Value IncludeTimeValue='False' Type='DateTime'>" + startDate + "</Value></Geq></Where></Query>";
            else if (endDate.length > 0)
                CAMLQuery = "<Query><Where><Leq><FieldRef Name='VP6800_x0020_Go_x0020_Live' /><Value IncludeTimeValue='False' Type='DateTime'>" + endDate + "</Value></Leq></Where></Query>";
            else
            ...
            var columns = [
                ...
                { key: 'VP6800ProjectSiteSurveyCompany', title: 'Site Survey Requested (Installation Company Assigned)', editable: true },
                ...
                { key: 'VP6800ProjectSiteSurveyDate', title: 'SITE SURVEY COMPLETED', transform: 'date', editable: true },
                { key: 'VP6800ReviewSignOffs', title: 'Site Survey Results Reviewed with FRAN', transform: 'date', editable: true },
                ...
                { key: 'VP6800Level10TrackingNum', title: 'Level 10 Tracking #', transform: 'date', editable: true },
                ...
                { key: 'RMAOrOpen', title: 'RMA OR<br />OPEN ITEMS', transform: 'date', editable: true },
            ...
            if (hashLoc.indexOf("golivedate") > -1) {
